...
export default function ChangePasswordForm({ setShowModal, toastRef }) {
    ...
    const ValidateForm = () =>{
        ...
        if(isEmpty(currentPassword)){
            setErrorNewPassword("Debes de ingresar tu contraseña actual.")
            isValid = false
        }

        if(size(newPassword) < 6){
            setErrorCurrentPassword("Debes de ingresar una nueva contraseña de al menos 6 carácteres.")
            isValid = false
        }

        if(size(confirmPassword) < 6){
            setErrorConfirmPassword("Debes de ingresar una confirmación de contraseña de al menos 6 carácteres.")
            isValid = false
        }
        ...
        if(newPassword === currentPassword){
            setErrorNewPassword("Debes de ingresar una contraseña diferente al actual.")
            setErrorCurrentPassword("Debes de ingresar una contraseña diferente al actual.")
            setErrorConfirmPassword("Debes de ingresar una contraseña diferente al actual.")
            isValid = false
        }
